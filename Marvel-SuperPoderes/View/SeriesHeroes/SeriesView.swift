...
struct SeriesView: View {
    ...
    var body: some View {
        NavigationStack {
            List {
                if let heroSeries = viewModel.series {
            ...
            .id(0)
            .onAppear {
                viewModel.getHerosSerie(for: hero)
            }
        }
    }
}
